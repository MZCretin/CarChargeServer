package com.cretin.www.carchargeserver.view;
...
import com.cretin.www.carchargeserver.utils.SystemUtil;
...
public class MyStatusView extends StatusView {
    ...
    public void initSettingView() {
        mSettingView.setOnClickListener(SystemUtil.getSettingNetwork());
    }
